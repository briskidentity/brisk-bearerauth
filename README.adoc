= Brisk BearerAuth image:https://travis-ci.com/briskidentity/brisk-bearerauth.svg?branch=master["Build Status", link="https://travis-ci.com/briskidentity/brisk-bearerauth"]
